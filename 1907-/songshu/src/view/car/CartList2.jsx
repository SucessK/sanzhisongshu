...
class CartList2 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            index:0,
    ...
    render() {
        ...
        return (
            <>
                ...
                {/*         className={`animate__animated animate__${this.state.selected}` } >*/}
                {/*        测试测试*/}
                {/*    </h1>*/}
                {/*</ReactCSSTransitionGroup>*/}
                ...
                <div  className={style.product_block} >
                    ...
                    {
                        this.state.index===0?this.props.items.map((v)=>(
                    ...
                    }
                    {
                        ...
                        this.state.index===1?this.props.items.map(v=>(
                    ...
                    }
                    {
                        ...
                        this.state.index===2?this.props.items.map(v=>(
...
export default connect(mapStateToProps,mapDispatchToProps)(loading(CartList2))